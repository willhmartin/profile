(function (e) {
  if ("object" == typeof exports && "undefined" != typeof module)
    ...
    var f;
    f = "undefined" == typeof window ? "undefined" == typeof global ? "undefined" == typeof self ? this : self : global : window,
      f.Trianglify = e()
  }
}
)(function () {
  var e, f = Math.sqrt, d = Math.abs, a = Math.min, n = Math.max, l = Math.floor;
  return function d(c, e, t) {
        ...
        if (e = function (e, f) {
          ...
          for (a in f)
            if (e.hasOwnProperty(a))
              ...
              throw new Error(a + " is not a configuration option for Trianglify. Check your spelling?");
          return d
        }(b, e),
          u = t(e.seed),
    ...
    "/Users/qrohlf/Code/trianglify/lib/pattern.js": [function (e, f) {
      (function (d) {
        ...
        f.exports = function (f, r) {
          function t(t) {
            var n;
            if ("object" == typeof d && "object" == typeof d.versions && "undefined" != typeof d.versions.node)
              try {
                e("canvas")
              } catch (f) {
                throw Error("The optional node-canvas dependency is needed for Trianglify to render using canvas in node.")
              }
            return t || (t = a.createElement("canvas")),
          ...
          return {
            ...
            svg: function (e) {
              ...
              return d.setAttribute("width", r.width),
                d.setAttribute("height", r.height),
                e && e.includeNamespace && d.setAttribute("xmlns", "http://www.w3.org/2000/svg"),
                f.forEach(function (e) {
    ...
    "/Users/qrohlf/Code/trianglify/node_modules/chroma-js/chroma.js": [function (r, t, s) {
      (function () {
        var o, r, c, u, i, h, p, b, g, y, _, m, x, w, j, v, k, q, C, U, B, z, G, S, P, R, A, L, Y, E, T, O, N, X, D, K, M, V, W, F = Number.MAX_VALUE, I = Math.cos, Z = Math.pow, J = Math.PI, H = Number.NaN, $ = Math.round;
        y = function (e, f, d, a) {
          return new o(e, f, d, a)
        }
          ,
          "undefined" != typeof t && null !== t && null != t.exports && (t.exports = y),
          ...
          y.interpolate = function (e, d, a, f) {
            return null == e || null == d ? "#000" : ("string" === D(e) && (e = new o(e)),
          ...
          o = function () {
            function e() {
              ...
              if (0 === d.length)
                ...
                "string" === D(d[0]) ? (n = d[0],
                  a = "hex") : "object" === D(d[0]) ? (u = d[0]._rgb,
                    n = u[0],
                    l = u[1],
                    s = u[2],
                    e = u[3],
                    a = "rgb") : 3 <= d.length && (n = d[0],
                      l = d[1],
                      s = d[2]);
              3 === d.length ? (a = "rgb",
                e = 1) : 4 === d.length ? "string" === D(d[3]) ? (a = d[3],
                  e = 1) : "number" === D(d[3]) && (a = "rgb",
                    e = d[3]) : 5 === d.length && (e = d[3],
                      a = d[4]),
                null == e && (e = 1),
                "rgb" === a ? r._rgb = [n, l, s, e] : "gl" === a ? r._rgb = [255 * n, 255 * l, 255 * s, e] : "hsl" === a ? (r._rgb = k(n, l, s),
                  r._rgb[3] = e) : "hsv" === a ? (r._rgb = q(n, l, s),
                    r._rgb[3] = e) : "hex" === a ? r._rgb = j(n) : "lab" === a ? (r._rgb = U(n, l, s),
                      r._rgb[3] = e) : "lch" === a ? (r._rgb = G(n, l, s),
                        r._rgb[3] = e) : "hsi" === a && (r._rgb = v(n, l, s),
                          r._rgb[3] = e),
                t = _(r._rgb)
            }
            return e.prototype.rgb = function () {
              ...
              e.prototype.luminance = function (f, a) {
                var r, t, n, s;
                return (null == a && (a = "rgb"),
                  !arguments.length) ? P(this._rgb) : (0 === f && (this._rgb = [0, 0, 0, this._rgb[3]]),
                    ...
                    s = function (e, r) {
                      var l, i;
                      return i = e.interpolate(0.5, r, a),
                        l = i.luminance(),
                        d(f - l) < t || !n-- ? i : l > f ? s(e, i) : s(i, r)
                    }
                    ,
                    this._rgb = (r > f ? s(new e("black"), this) : s(this, new e("white"))).rgba(),
                    this)
              }
              ,
              ...
              e.prototype.css = function (e) {
                ...
                return (null == e && (e = "rgb"),
                  ...
                  "rgb" === e) ? e + "(" + a.slice(0, 3).map(Math.round).join(",") + ")" : "rgba" === e ? e + "(" + a.slice(0, 3).map(Math.round).join(",") + "," + a[3] + ")" : "hsl" === e || "hsla" === e ? (f = d.hsl(),
                    r = function (e) {
                      return $(100 * e) / 100
                    }
                    ,
              ...
              e.prototype.interpolate = function (d, f, a) {
                ...
                if (c = this,
                  ...
                  "hsl" === a ? (p = c.hsl(),
                    m = f.hsl()) : "hsv" === a ? (p = c.hsv(),
                      m = f.hsv()) : "hsi" === a ? (p = c.hsi(),
                        m = f.hsi()) : "lch" === a && (p = c.lch(),
                          m = f.lch()),
                    "h" === a.substr(0, 1) ? (n = p[0],
                      g = p[1],
                      i = p[2],
                      l = m[0],
                      u = m[1],
                      o = m[2]) : (i = p[0],
                        ...
                        u = m[1],
                        l = m[2]),
                    isNaN(n) || isNaN(l) ? isNaN(n) ? isNaN(l) ? t = H : (t = l,
                      (1 === i || 0 === i) && "hsv" !== a && (h = u)) : (t = n,
                        (1 === o || 0 === o) && "hsv" !== a && (h = g)) : (r = l > n && 180 < l - n ? l - (n + 360) : l < n && 180 < n - l ? l + 360 - n : l - n,
                          t = n + d * r),
                    null == h && (h = g + d * (u - g)),
                    s = i + d * (o - i),
                    b = "h" === a.substr(0, 1) ? new e(t, h, s, a) : new e(s, h, t, a);
                else if ("rgb" === a)
                  p = c._rgb,
                    m = f._rgb,
                    b = new e(p[0] + d * (m[0] - p[0]), p[1] + d * (m[1] - p[1]), p[2] + d * (m[2] - p[2]), a);
                else if ("lab" === a)
                  p = c.lab(),
                    m = f.lab(),
                    b = new e(p[0] + d * (m[0] - p[0]), p[1] + d * (m[1] - p[1]), p[2] + d * (m[2] - p[2]), a);
                else
                  throw "color mode " + a + " is not supported";
                return b.alpha(c.alpha() + d * (f.alpha() - c.alpha())),
                  b
              }
              ,
          ...
          _ = function (e) {
            for (var f in e)
              3 > f ? (0 > e[f] && (e[f] = 0),
                255 < e[f] && (e[f] = 255)) : 3 === f && (0 > e[f] && (e[f] = 0),
                  1 < e[f] && (e[f] = 1));
            return e
          }
          ,
          w = function (e) {
            ...
            if (a = e.match(/rgb\(\s*(\-?\d+),\s*(\-?\d+)\s*,\s*(\-?\d+)\s*\)/)) {
              ...
              (a = e.match(/hsl\(\s*(\-?\d+(?:\.\d+)?),\s*(\-?\d+(?:\.\d+)?)%\s*,\s*(\-?\d+(?:\.\d+)?)%\s*\)/)) ? (f = a.slice(1, 4),
                f[1] *= 0.01,
                f[2] *= 0.01,
                r = k(f),
                r[3] = 1) : (a = e.match(/hsla\(\s*(\-?\d+(?:\.\d+)?),\s*(\-?\d+(?:\.\d+)?)%\s*,\s*(\-?\d+(?:\.\d+)?)%\s*,\s*([01]|[01]?\.\d+)\)/)) && (f = a.slice(1, 4),
                  f[1] *= 0.01,
                  f[2] *= 0.01,
                  r = k(f),
                  r[3] = +a[4]);
          ...
          k = function () {
            ...
            if (b = K(arguments),
              ...
              for (o = [0, 0, 0],
                ...
                0 > o[t] && (o[t] += 1),
                  1 < o[t] && (o[t] -= 1),
                  f[t] = 1 > 6 * o[t] ? s + 6 * (i - s) * o[t] : 1 > 2 * o[t] ? i : 2 > 3 * o[t] ? s + 6 * ((i - s) * (2 / 3 - o[t])) : s;
          ...
          q = function () {
            ...
            return b = K(arguments),
              a = b[0],
              r = b[1],
              t = b[2],
              t *= 255,
              0 === r ? c = f = e = t : (360 === a && (a = 0),
                360 < a && (a -= 360),
                0 > a && (a += 360),
                a /= 60,
                n = l(a),
          ...
          Y = function (e, f, d) {
            ...
            return void 0 !== e && 3 <= e.length && (s = e,
              ...
              t = (l + i) / 2,
              l === i ? (o = 0,
                r = H) : o = 0.5 > t ? (l - i) / (l + i) : (l - i) / (2 - l - i),
              e === l ? r = (f - d) / (l - i) : f === l ? r = 2 + (d - e) / (l - i) : d === l && (r = 4 + (e - f) / (l - i)),
              r *= 60,
              0 > r && (r += 360),
              [r, o, t]
          }
          ...
          y.scale = function (e, r) {
            ...
            return j = "rgb",
              ...
              c = function (e, f) {
                var d, a, r, t, n, l, s;
                if (null == e && (e = ["#ddd", "#222"]),
                  null != e && "string" === D(e) && null != (null == (n = y.brewer) ? void 0 : n[e]) && (e = y.brewer[e]),
                  "array" === D(e)) {
                  for (e = e.slice(0),
                    d = r = 0,
                    l = e.length - 1; 0 <= l ? r <= l : r >= l; d = 0 <= l ? ++r : --r)
                    a = e[d],
                      "string" === D(a) && (e[d] = y(a));
                  if (null != f)
                    C = f;
                    ...
                    for (C = [],
                      d = t = 0,
                      s = e.length - 1; 0 <= s ? t <= s : t >= s; d = 0 <= s ? ++t : --t)
                      C.push(d / (e.length - 1))
                }
                return o(),
                  u = e
              ...
              t = function (e) {
                var d, a, r, t, n;
                return n = e,
                  2 < m.length && (t = m.length - 1,
                    d = f(e),
                    r = m[0] + (m[1] - m[0]) * (0 + 0.5 * z),
                    a = m[t - 1] + (m[t] - m[t - 1]) * (1 - 0.5 * z),
                    n = w + (m[d] + 0.5 * (m[d + 1] - m[d]) - r) / (a - r) * (_ - w)),
                  n
              }
              ,
              i = function (e, d) {
                ...
                if (null == d && (d = !1),
                  isNaN(e))
                  return v;
                if (d ? p = e : 2 < m.length ? (r = f(e),
                  p = r / (q - 1)) : (p = o = w === _ ? 0 : (e - w) / (_ - w),
                    p = o = (e - w) / (_ - w),
                    p = a(1, n(0, p))),
                  d || (p = h(p)),
                  i = l(1e4 * p),
                  ...
                  if ("array" === D(u))
                    for (c = t = 0,
                      x = C.length - 1; 0 <= x ? t <= x : t >= x; c = 0 <= x ? ++t : --t) {
                      if (b = C[c],
                        p <= b) {
                        s = u[c];
                        break
              ...
              s.domain = function (e, f, a, r) {
                var t;
                return (null == a && (a = "e"),
                  !arguments.length) ? m : (null != f && (t = y.analyze(e, r),
              ...
              s.colors = function (f) {
                ...
                if (null == f && (f = "hex"),
                  ...
                  2 < m.length)
                  for (d = r = 1,
                    l = m.length; 1 <= l ? r < l : r > l; d = 1 <= l ? ++r : --r)
          ...
          y.analyze = function (e, f, d) {
            ...
            if (n = {
              ...
              l = function (e, r) {
                if (d(e, r))
                  return null != f && "function" === D(f) ? a(f(e)) : null != f && "string" === D(f) || "number" === D(f) ? a(e[f]) : a(e)
              }
              ,
              "array" === D(e))
              for (s = 0,
          ...
          y.limits = function (e, f, a) {
            var r, t, s, o, c, b, h, i, g, u, m, x, _, w, j, v, n, k, q, p, C, z, U, B, G, S, P, R, A, L, Y, E, T, O, N, X, K, M, V, W, I, J, H, $, Q, ee, fe, de, ae, re, te, ne, le, se, ie, oe, ce = Math.log, be = Math.LOG10E;
            if (null == f && (f = "equal"),
              null == a && (a = 7),
              ...
              u = [],
              "c" === f.substr(0, 1) && (u.push(_),
                u.push(m)),
              "e" === f.substr(0, 1)) {
              for (u.push(_),
                h = P = 1,
                K = a - 1; 1 <= K ? P <= K : P >= K; h = 1 <= K ? ++P : --P)
                u.push(_ + h / a * (m - _));
              u.push(m)
              ...
              for (u.push(_),
                h = A = 1,
                Q = a - 1; 1 <= Q ? A <= Q : A >= Q; h = 1 <= Q ? ++A : --A)
                q = S.length * h / a,
                  p = l(q),
                  p === q ? u.push(S[p]) : (C = q - p,
                    u.push(S[p] * C + S[p + 1] * (1 - C)));
              u.push(m)
              ...
              for (v = S.length,
                ...
                s.push(_),
                (h = L = 1,
                  ee = a - 1); 1 <= ee ? L <= ee : L >= ee; h = 1 <= ee ? ++L : --L)
                s.push(_ + h / a * (m - _));
              for (s.push(m); z;) {
                for (i = Y = 0,
                  fe = a - 1; 0 <= fe ? Y <= fe : Y >= fe; i = 0 <= fe ? ++Y : --Y)
                  c[i] = 0;
                for (h = E = 0,
                  de = v - 1; 0 <= de ? E <= de : E >= de; h = 0 <= de ? ++E : --E) {
                  for (G = S[h],
                    j = F,
                    (i = T = 0,
                      ae = a - 1); 0 <= ae ? T <= ae : T >= ae; i = 0 <= ae ? ++T : --T)
                    b = d(s[i] - G),
                      b < j && (j = b,
                        t = i);
                  c[t]++,
                ...
                for (k = Array(a),
                  i = O = 0,
                  re = a - 1; 0 <= re ? O <= re : O >= re; i = 0 <= re ? ++O : --O)
                  k[i] = null;
                for (h = N = 0,
                  te = v - 1; 0 <= te ? N <= te : N >= te; h = 0 <= te ? ++N : --N)
                  o = r[h],
                    null === k[o] ? k[o] = S[h] : k[o] += S[h];
                for (i = X = 0,
                  M = a - 1; 0 <= M ? X <= M : X >= M; i = 0 <= M ? ++X : --X)
                  k[i] *= 1 / c[i];
                for (z = !1,
                  i = ne = 0,
                  V = a - 1; 0 <= V ? ne <= V : ne >= V; i = 0 <= V ? ++ne : --ne)
                  if (k[i] !== s[h]) {
                    z = !0;
                    break
                  }
              ...
              for (g = {},
                i = le = 0,
                W = a - 1; 0 <= W ? le <= W : le >= W; i = 0 <= W ? ++le : --le)
                g[i] = [];
              for (h = se = 0,
                I = v - 1; 0 <= I ? se <= I : se >= I; h = 0 <= I ? ++se : --se)
                o = r[h],
                  g[o].push(S[h]);
              for (B = [],
                i = ie = 0,
                J = a - 1; 0 <= J ? ie <= J : ie >= J; i = 0 <= J ? ++ie : --ie)
                B.push(g[i][0]),
          ...
          D = function () {
            ...
            return function (f) {
              var d;
              return d = Object.prototype.toString.call(f),
                e[d] || "object"
            }
          }(),
          S = function (e, f, d) {
              ...
              2 === e.length ? (t = function () {
                ...
                f = function (e) {
                  ...
                  return d = function () {
                    ...
                    for (a = [],
                      f = d = 0; 2 >= d; f = ++d)
                      a.push((1 - e) * (1 - e) * n[f] + 2 * (1 - e) * e * l[f] + e * e * s[f]);
                    return a
                  }(),
                    y.lab.apply(y, d)
                }
                ...
                f = function (e) {
                  ...
                  return d = function () {
                    ...
                    for (a = [],
                      f = d = 0; 2 >= d; f = ++d)
                      a.push((1 - e) * (1 - e) * (1 - e) * n[f] + 3 * (1 - e) * (1 - e) * e * l[f] + 3 * (1 - e) * e * e * s[f] + e * e * e * o[f]);
                    return a
                  }(),
                    y.lab.apply(y, d)
                }
              ) : 5 === e.length && (d = b(e.slice(0, 3)),
                a = b(e.slice(2, 5)),
                f = function (e) {
    ...
    "/Users/qrohlf/Code/trianglify/node_modules/delaunator/index.js": [function (e, a) {
      ...
      function r(a, l, s) {
        ...
        var y, B, G, S = (u + j) / 2, P = (w + v) / 2, R = Infinity;
        ...
        for (R = Infinity,
          U = 0; U < a.length; U++)
          U !== y && (A = t(C[2 * y], C[2 * y + 1], C[2 * U], C[2 * U + 1]),
            A < R && 0 < A && (B = U,
              R = A));
        var d = Infinity;
        for (U = 0; U < a.length; U++)
        ...
        for (var W, F, I = 0; I < z.length; I++)
          if (U = z[I],
            ...
            (p !== W || x !== F) && (W = p,
              F = x,
              (p !== Y || x !== E) && (p !== T || x !== O) && (p !== N || x !== X))) {
            var k, Z = this._hashKey(p, x), J = Z;
            do
              k = this._hash[J],
                J = (J + 1) % this._hashSize;
            while ((!k || k.removed) && J !== Z); for (K = k; 0 <= n(p, x, K.x, K.y, K.next.x, K.next.y);)
              if (K = K.next,
                K === k)
            ...
            for (var Q = K.next; 0 > n(p, x, Q.x, Q.y, Q.next.x, Q.next.y);)
            ...
            if (H)
              for (Q = K.prev; 0 > n(p, x, Q.prev.x, Q.prev.y, Q.x, Q.y);)
                $ = this._addTriangle(Q.prev.i, U, Q.i, -1, Q.t, Q.prev.t),
                  this._legalize($ + 2),
                  Q.prev.t = $,
                  this.hull = h(Q),
                  Q = Q.prev;
            this._hashEdge(K),
              this._hashEdge(K.prev)
          }
      ...
      function g(e, f, d, a, r, t) {
        ...
        if (20 >= a - d)
          ...
          for (n = d + 1,
            ...
            do
              n++;
            while (0 > u(f, e[n], s, r, t)); do
              l--;
            while (0 < u(f, e[l], s, r, t)); if (l < n)
              break;
            p(e, n, l)
          }
          e[d + 1] = e[l],
            e[l] = s,
            a - n + 1 >= l - d ? (g(e, f, n, a, r, t),
              g(e, f, d, l - 1, r, t)) : (g(e, f, d, l - 1, r, t),
                g(e, f, n, a, r, t))
        }
      }
      ...
      (function (e, f, d) {
        function a(e) {
          ...
          f.next = function () {
            ...
            f.c = -1640531527,
            f.d = 1367130551,
            e === l(e) ? (f.a = 0 | e / 4294967296,
              f.b = 0 | e) : d += e;
          for (var a = 0; a < d.length + 20; a++)
            f.b ^= 0 | d.charCodeAt(a),
              f.next()
        }
        function r(e, f) {
          return f.a = e.a,
    ...
    "/Users/qrohlf/Code/trianglify/node_modules/seedrandom/lib/xor4096.js": [function (f, d) {
      (function (e, f, d) {
        function a(e) {
          var f = this;
          f.next = function () {
            var e, d, a = f.w, r = f.X, t = f.i;
            return f.w = a = 0 | a + 1640531527,
              d = r[127 & t + 34],
              e = r[t = 127 & t + 1],
              d ^= d << 13,
              e ^= e << 17,
            ...
            function (e, f) {
              ...
              for (f === (0 | f) ? (a = f,
                ...
                f && (a ^= f.charCodeAt((t + 32) % f.length)),
                  ...
                  a ^= a << 4,
                  a ^= a >>> 13,
                  0 <= t && (l = 0 | l + 1640531527,
                    d = s[127 & t] ^= a + l,
                    r = 0 == d ? r + 1 : 0);
              for (128 <= r && (s[127 & (f && f.length || 0)] = -1),
                r = 127,
                t = 512; 0 < t; --t)
                a = s[127 & r + 34],
                  d = s[r = 127 & r + 1],
          ...
          f.next = function () {
            ...
            function (e, f) {
              ...
              if (f === (0 | f))
                ...
                for (f = "" + f,
                  d = 0; d < f.length; ++d)
                  r[7 & d] = r[7 & d] << 15 ^ f.charCodeAt(d) + r[7 & d + 1] << 13;
              for (; 8 > r.length;)
                r.push(0);
              for (d = 0; 8 > d && 0 === r[d]; ++d)
                ;
        ...
        function a(e) {
          ...
          f.next = function () {
            ...
            return f.x = f.y,
              ...
              f.z = f.w,
              f.w = f.v,
              0 | (f.d = 0 | f.d + 362437) + (f.v = f.v ^ f.v << 4 ^ (e ^ e << 1))
          }
            ,
            f.x = 0,
            f.y = 0,
    ...
    "/Users/qrohlf/Code/trianglify/node_modules/seedrandom/seedrandom.js": [function (f, d) {
      (function (a, r) {
        ...
        function n(e) {
          var f, d = e.length, a = this, r = 0, t = a.i = a.j = 0, n = a.S = [];
          for (d || (e = [d++]); r < g;)
            n[r] = r++;
          for (r = 0; r < g; r++)
            n[r] = n[t = x & t + e[r % d] + (f = n[r])],
              n[t] = f;
          (a.g = function (e) {
            for (var f, d = 0, r = a.i, t = a.j, n = a.S; e--;)
              f = n[r = x & r + 1],
                d = d * g + n[x & (n[r] = n[t = x & t + f]) + (n[t] = f)];
            return a.i = r,
              a.j = t,
              d
          }
        ...
        function o() {
          try {
            var e;
            return b && (e = b.randomBytes) ? e = e(g) : (e = new Uint8Array(g),
        ...
        var b, h = this, g = 256, u = 6, p = "random", m = r.pow(g, u), y = r.pow(2, 52), _ = 2 * y, x = g - 1;
        if (r["seed" + p] = t,
          i(r.random(), a),
